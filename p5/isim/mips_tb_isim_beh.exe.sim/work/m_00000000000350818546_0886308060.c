...
#endif
static const char *ng0 = "D:/ISE/p5/ALU.v";
...
LAB80:    if (*((unsigned int *)t233) > 0)
        goto LAB81;

LAB82:    if (*((unsigned int *)t225) > 0)
        goto LAB83;

LAB84:    memcpy(t224, t245, 8);
...
LAB77:    t237 = (t0 + 1048U);
    ...
    t239 = *((char **)t237);
    memset(t240, 0, 8);
    xsi_vlog_unsigned_minus(t240, 32, t238, 32, t239, 32);
    goto LAB78;
...
LAB107:    if (*((unsigned int *)t304) > 0)
        goto LAB108;

LAB109:    if (*((unsigned int *)t246) > 0)
        goto LAB110;

LAB111:    memcpy(t245, t342, 8);

LAB112:    goto LAB80;

LAB81:    xsi_vlog_unsigned_bit_combine(t224, 32, t240, 32, t245, 32);
    goto LAB85;

LAB83:    memcpy(t224, t240, 8);
    goto LAB85;
...
LAB94:    if (*((unsigned int *)t260) != 0)
        goto LAB95;

LAB96:    t270 = *((unsigned int *)t248);
...
LAB123:    if (*((unsigned int *)t352) > 0)
        goto LAB124;

LAB125:    if (*((unsigned int *)t343) > 0)
        goto LAB126;

LAB127:    memcpy(t342, t372, 8);

LAB128:    goto LAB107;

LAB108:    xsi_vlog_unsigned_bit_combine(t245, 32, t311, 32, t342, 32);
    goto LAB112;

LAB110:    memcpy(t245, t311, 8);
    goto LAB112;

LAB113:    t322 = *((unsigned int *)t311);
...
LAB120:    t357 = ((char*)((ng1)));
    ...
    *((unsigned int *)t358) = (t366 & 65535U);
    t367 = *((unsigned int *)t359);
    *((unsigned int *)t359) = (t367 & 65535U);
    xsi_vlogtype_concat(t356, 32, 32, 2U, t358, 16, t357, 16);
    goto LAB121;

LAB122:    t372 = ((char*)((ng2)));
    goto LAB123;

LAB124:    xsi_vlog_unsigned_bit_combine(t342, 32, t356, 32, t372, 32);
    goto LAB128;

LAB126:    memcpy(t342, t356, 8);
    goto LAB128;
...
LAB100:    t441 = (t0 + 7808);
    ...
    t445 = *((char **)t444);
    memcpy(t445, t3, 8);
    xsi_driver_vfirst_trans(t441, 0, 31);
    t446 = (t0 + 6576);
    *((int *)t446) = 1;
...
LAB132:    t431 = (t323 + 4);
    t432 = *((unsigned int *)t323);
    t433 = *((unsigned int *)t431);
    t434 = (t432 || t433);
    if (t434 > 0)
        goto LAB133;

LAB134:    t437 = *((unsigned int *)t323);
    t438 = (~(t437));
...
LAB140:    memcpy(t322, t435, 8);

LAB141:    goto LAB95;

LAB96:    xsi_vlog_unsigned_bit_combine(t3, 32, t317, 32, t322, 32);
    goto LAB100;
...
LAB133:    t435 = (t0 + 1848U);
    t436 = *((char **)t435);
    goto LAB134;

LAB135:    t435 = ((char*)((ng2)));
    goto LAB136;

LAB137:    xsi_vlog_unsigned_bit_combine(t322, 32, t436, 32, t435, 32);
    goto LAB141;

LAB139:    memcpy(t322, t436, 8);
    goto LAB141;

}


extern void work_m_00000000000350818546_0886308060_init()
{
	static char *pe[] = {(void *)Cont_31_0,(void *)Cont_33_1,(void *)Cont_39_2};
	xsi_register_didat("work_m_00000000000350818546_0886308060", "isim/mips_tb_isim_beh.exe.sim/work/m_00000000000350818546_0886308060.didat");
