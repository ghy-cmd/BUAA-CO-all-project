...
#endif
static const char *ng0 = "D:/ISE/p5/DM.v";
static int ng1[] = {0, 0};
...
LAB142:    t491 = (t0 + 9032);
    ...
    t495 = *((char **)t494);
    memcpy(t495, t3, 8);
    xsi_driver_vfirst_trans(t491, 0, 31);
    t496 = (t0 + 7800);
    *((int *)t496) = 1;
...
LAB134:    t466 = (t0 + 1688U);
    t467 = *((char **)t466);
    goto LAB135;

LAB136:    t466 = (t0 + 3128U);
    t474 = *((char **)t466);
    memset(t473, 0, 8);
    t466 = (t474 + 4);
...
LAB154:    memcpy(t472, t485, 8);

LAB155:    goto LAB137;

LAB138:    xsi_vlog_unsigned_bit_combine(t3, 32, t467, 32, t472, 32);
    goto LAB142;
...
LAB147:    t485 = (t0 + 1208U);
    t486 = *((char **)t485);
    goto LAB148;

LAB149:    t485 = ((char*)((ng1)));
    goto LAB150;

LAB151:    xsi_vlog_unsigned_bit_combine(t472, 32, t486, 32, t485, 32);
    goto LAB155;

LAB153:    memcpy(t472, t486, 8);
    goto LAB155;

}


extern void work_m_00000000000806216360_2924402094_init()
{
	static char *pe[] = {(void *)Cont_37_0,(void *)Always_38_1,(void *)Cont_57_2,(void *)Cont_59_3};
	xsi_register_didat("work_m_00000000000806216360_2924402094", "isim/mips_tb_isim_beh.exe.sim/work/m_00000000000806216360_2924402094.didat");
