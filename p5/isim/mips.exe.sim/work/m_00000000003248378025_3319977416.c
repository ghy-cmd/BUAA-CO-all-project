...
LAB100:    t337 = (t0 + 7072);
    ...
    t341 = *((char **)t340);
    memcpy(t341, t3, 8);
    xsi_driver_vfirst_trans(t337, 0, 31);
    t342 = (t0 + 6080);
    *((int *)t342) = 1;
...
LAB92:    t317 = (t0 + 1048U);
    ...
    *((unsigned int *)t320) = t329;
    xsi_vlog_mul_concat(t319, 16, 1, t317, 1U, t322, 1);
    xsi_vlogtype_concat(t316, 32, 32, 2U, t319, 16, t318, 16);
    goto LAB93;

LAB94:    t335 = (t0 + 1048U);
    t336 = *((char **)t335);
    t335 = ((char*)((ng1)));
    xsi_vlogtype_concat(t334, 32, 32, 2U, t335, 16, t336, 16);
    goto LAB95;

LAB96:    xsi_vlog_unsigned_bit_combine(t3, 32, t316, 32, t334, 32);
    goto LAB100;
...
extern void work_m_00000000003248378025_3319977416_init()
{
	static char *pe[] = {(void *)Cont_31_0,(void *)Cont_32_1,(void *)Cont_34_2};
	xsi_register_didat("work_m_00000000003248378025_3319977416", "isim/mips.exe.sim/work/m_00000000003248378025_3319977416.didat");
