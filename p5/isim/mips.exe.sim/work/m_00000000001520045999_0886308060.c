...
LAB50:    t166 = (t0 + 1048U);
    ...
    t168 = *((char **)t166);
    memset(t169, 0, 8);
    xsi_vlog_unsigned_add(t169, 32, t167, 32, t168, 32);
    goto LAB51;
...
LAB68:    if (*((unsigned int *)t175) > 0)
        goto LAB69;

LAB70:    memcpy(t174, t195, 8);
...
LAB63:    t187 = (t0 + 1048U);
    ...
    t189 = *((char **)t187);
    memset(t190, 0, 8);
    xsi_vlog_unsigned_minus(t190, 32, t188, 32, t189, 32);
    goto LAB64;
...
LAB77:    memcpy(t219, t198, 8);

LAB78:    memset(t196, 0, 8);
    t247 = (t219 + 4);
...
LAB95:    if (*((unsigned int *)t196) > 0)
        goto LAB96;

LAB97:    memcpy(t195, t292, 8);

LAB98:    goto LAB66;

LAB67:    xsi_vlog_unsigned_bit_combine(t174, 32, t190, 32, t195, 32);
    goto LAB71;

LAB69:    memcpy(t174, t190, 8);
    goto LAB71;

LAB72:    *((unsigned int *)t198) = 1;
    goto LAB75;
...
LAB109:    if (*((unsigned int *)t302) > 0)
        goto LAB110;

LAB111:    if (*((unsigned int *)t293) > 0)
        goto LAB112;

LAB113:    memcpy(t292, t322, 8);

LAB114:    goto LAB93;

LAB94:    xsi_vlog_unsigned_bit_combine(t195, 32, t261, 32, t292, 32);
    goto LAB98;

LAB96:    memcpy(t195, t261, 8);
    goto LAB98;

LAB99:    t272 = *((unsigned int *)t261);
...
LAB108:    t322 = ((char*)((ng1)));
    goto LAB109;

LAB110:    xsi_vlog_unsigned_bit_combine(t292, 32, t306, 32, t322, 32);
    goto LAB114;

LAB112:    memcpy(t292, t306, 8);
    goto LAB114;
...
LAB98:    memcpy(t272, t285, 8);

LAB99:    goto LAB81;

LAB82:    xsi_vlog_unsigned_bit_combine(t3, 32, t267, 32, t272, 32);
    goto LAB86;

LAB84:    memcpy(t3, t267, 8);
    goto LAB86;
...
LAB95:    xsi_vlog_unsigned_bit_combine(t272, 32, t286, 32, t285, 32);
    goto LAB99;

LAB97:    memcpy(t272, t286, 8);
    goto LAB99;

}


extern void work_m_00000000001520045999_0886308060_init()
{
	static char *pe[] = {(void *)Cont_31_0,(void *)Cont_33_1,(void *)Cont_39_2};
	xsi_register_didat("work_m_00000000001520045999_0886308060", "isim/mips.exe.sim/work/m_00000000001520045999_0886308060.didat");
