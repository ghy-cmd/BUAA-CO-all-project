...
LAB118:    t381 = (t323 + 4);
    t382 = *((unsigned int *)t323);
    t383 = *((unsigned int *)t381);
    t384 = (t382 || t383);
    if (t384 > 0)
        goto LAB119;

LAB120:    t387 = *((unsigned int *)t323);
    t388 = (~(t387));
...
LAB124:    if (*((unsigned int *)t323) > 0)
        goto LAB125;

LAB126:    memcpy(t322, t385, 8);
...
LAB121:    t385 = ((char*)((ng1)));
    goto LAB122;

LAB123:    xsi_vlog_unsigned_bit_combine(t322, 32, t386, 32, t385, 32);
    goto LAB127;

LAB125:    memcpy(t322, t386, 8);
    goto LAB127;

}


extern void work_m_00000000002041816747_0886308060_init()
{
	static char *pe[] = {(void *)Cont_31_0,(void *)Cont_33_1,(void *)Cont_39_2};
	xsi_register_didat("work_m_00000000002041816747_0886308060", "isim/mips.exe.sim/work/m_00000000002041816747_0886308060.didat");
