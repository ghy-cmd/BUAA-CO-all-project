...
#endif
static const char *ng0 = "D:/ISE/gswp7/cmp.v";
...
LAB54:    t140 = (t0 + 1208U);
    ...
    t140 = ((char*)((ng4)));
    memset(t143, 0, 8);
    xsi_vlog_signed_leq(t143, 32, t141, 32, t140, 32);
    goto LAB55;
...
LAB76:    if (*((unsigned int *)t149) > 0)
        goto LAB77;

LAB78:    memcpy(t148, t188, 8);

LAB79:    goto LAB57;

LAB58:    xsi_vlog_unsigned_bit_combine(t108, 1, t143, 1, t148, 1);
    goto LAB62;

LAB60:    memcpy(t108, t143, 8);
    goto LAB62;
...
LAB71:    t180 = (t0 + 1208U);
    ...
    t180 = ((char*)((ng4)));
    memset(t183, 0, 8);
    xsi_vlog_signed_greater(t183, 32, t181, 32, t180, 32);
    goto LAB72;
...
LAB81:    *((unsigned int *)t192) = 1;

LAB83:    memset(t189, 0, 8);
    t208 = (t192 + 4);
...
LAB91:    if (*((unsigned int *)t215) > 0)
        goto LAB92;

LAB93:    if (*((unsigned int *)t189) > 0)
        goto LAB94;

LAB95:    memcpy(t188, t228, 8);

LAB96:    goto LAB74;

LAB75:    xsi_vlog_unsigned_bit_combine(t148, 1, t183, 1, t188, 1);
    goto LAB79;

LAB77:    memcpy(t148, t183, 8);
    goto LAB79;
...
LAB88:    t220 = (t0 + 1208U);
    ...
    t220 = ((char*)((ng4)));
    memset(t223, 0, 8);
    xsi_vlog_signed_less(t223, 32, t221, 32, t220, 32);
    goto LAB89;
...
LAB108:    if (*((unsigned int *)t255) > 0)
        goto LAB109;

LAB110:    if (*((unsigned int *)t229) > 0)
        goto LAB111;

LAB112:    memcpy(t228, t268, 8);

LAB113:    goto LAB91;

LAB92:    xsi_vlog_unsigned_bit_combine(t188, 1, t223, 1, t228, 1);
    goto LAB96;

LAB94:    memcpy(t188, t223, 8);
    goto LAB96;
...
LAB105:    t260 = (t0 + 1208U);
    t261 = *((char **)t260);
    t260 = ((char*)((ng4)));
    memset(t263, 0, 8);
    xsi_vlog_signed_greatereq(t263, 32, t261, 32, t260, 32);
    goto LAB106;

LAB107:    t268 = ((char*)((ng8)));
    goto LAB108;

LAB109:    xsi_vlog_unsigned_bit_combine(t228, 1, t263, 1, t268, 1);
    goto LAB113;

LAB111:    memcpy(t228, t263, 8);
    goto LAB113;

}


extern void work_m_00000000003855393322_3363942390_init()
{
	static char *pe[] = {(void *)Cont_8_0};
	xsi_register_didat("work_m_00000000003855393322_3363942390", "isim/mips_tb_isim_beh.exe.sim/work/m_00000000003855393322_3363942390.didat");
