...
#endif
static const char *ng0 = "D:/ISE/gswp7/IFID.v";
static int ng1[] = {0, 0};
static int ng2[] = {1, 0};
static int ng3[] = {4, 0};
...
LAB62:    memcpy(t126, t87, 8);

LAB63:    memset(t154, 0, 8);
    t155 = (t126 + 4);
...
LAB80:    memcpy(t193, t154, 8);

LAB81:    memset(t221, 0, 8);
    t222 = (t193 + 4);
...
LAB98:    memcpy(t260, t221, 8);

LAB99:    memset(t288, 0, 8);
    t289 = (t260 + 4);
...
LAB116:    memcpy(t327, t288, 8);

LAB117:    memset(t355, 0, 8);
    t356 = (t327 + 4);
...
LAB134:    memcpy(t394, t355, 8);

LAB135:    memset(t422, 0, 8);
    t423 = (t394 + 4);
...
LAB152:    memcpy(t461, t422, 8);

LAB153:    memset(t489, 0, 8);
    t490 = (t461 + 4);
...
LAB170:    memcpy(t528, t489, 8);

LAB171:    memset(t556, 0, 8);
    t557 = (t528 + 4);
...
LAB188:    memcpy(t595, t556, 8);

LAB189:    t623 = (t0 + 3048);
    xsi_vlogvar_wait_assign_value(t623, t595, 0, 0, 1, 0LL);
    goto LAB20;
...
LAB30:    xsi_vlog_unsigned_bit_combine(t7, 32, t6, 32, t11, 32);
    goto LAB34;

LAB32:    memcpy(t7, t6, 8);
    goto LAB34;
...
LAB105:    if (*((unsigned int *)t253) != 0)
        goto LAB106;

LAB107:    t261 = *((unsigned int *)t221);
...
LAB137:    *((unsigned int *)t370) = 1;

LAB139:    memset(t386, 0, 8);
    t387 = (t370 + 4);
...
LAB141:    if (*((unsigned int *)t387) != 0)
        goto LAB142;

LAB143:    t395 = *((unsigned int *)t355);
...
LAB173:    *((unsigned int *)t504) = 1;

LAB175:    memset(t520, 0, 8);
    t521 = (t504 + 4);
...
LAB191:    *((unsigned int *)t571) = 1;

LAB193:    memset(t587, 0, 8);
    t588 = (t571 + 4);
...
extern void work_m_00000000001371684115_1298333783_init()
{
	static char *pe[] = {(void *)Always_16_0};
	xsi_register_didat("work_m_00000000001371684115_1298333783", "isim/mips_tb_isim_beh.exe.sim/work/m_00000000001371684115_1298333783.didat");
